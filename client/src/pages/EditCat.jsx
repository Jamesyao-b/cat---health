...
function EditCat({ cat, onNavigate, onRefresh }) {
  ...
  const [formData, setFormData] = useState({
    ...
    gender: cat.gender,
    isNeutered: cat.isNeutered.toString(),
    weight: cat.weight,
    activityLevel: cat.activityLevel || 'normal',
          ...
          <div className="form-step">
            ...
            <div className="form-group">
              ...
              <input
                ...
                step="0.1"
              />
              <span className="hint">体重范围: 0-20 kg</span>
            </div>
